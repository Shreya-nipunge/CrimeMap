        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-8 text-center relative z-10">
            <p className="text-slate-500 text-sm">
              ...
              <Link to="/register-user" className="text-blue-400 hover:text-blue-300 transition-colors font-bold ml-1">
                Register
              </Link>
            </p>
          </div>
